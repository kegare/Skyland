...
public class SkyBlocks
{
	...
	public static final Block skyrite_block = new BlockCompressed(MapColor.airColor).setHardness(5.5F).setResistance(10.0F).setStepSound(Block.soundTypeMetal).setUnlocalizedName("blockSkyrite").setCreativeTab(Skyland.tabSkyland);
